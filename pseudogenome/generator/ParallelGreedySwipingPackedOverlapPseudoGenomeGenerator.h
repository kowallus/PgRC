...
namespace PgSAIndex {
    ...
    class ParallelGreedySwipingPackedOverlapGeneratorTemplate: public AbstractOverlapPseudoGenomeGeneratorTemplate<uint_read_len, uint_reads_cnt>
    {
        private:
            ...
            void groupSortedReadsLeft(const std::function <bool (const uint_reads_cnt&)>& isReadsLeftPredicate);
    ...
    protected:
        virtual void setDuplicateSuccessor(uint_reads_cnt curIdx, uint_reads_cnt nextIdx, uint_read_len overlapLenght);
